...
def run_height_estimator():
    ...
    if img_file:
        ...
        # Display image and generate URL (Streamlit automatically handles image)
        img_slot = st.image(image, use_column_width=False)
        img_url = img_slot.image_url  # Dynamic URL generated by Streamlit

        canvas_result = st_canvas(
            fill_color="rgba(255, 165, 0, 0.3)",
            stroke_width=3,
            stroke_color="#e00",
            background_image_url=img_url,  # Use the generated URL
